...
학기 프로젝트 기준은 [2026년 2학기 운영 커리큘럼](../curriculum/2026-2/00_운영_커리큘럼.md)과 [기말 프로젝트 기획서 가이드](../curriculum/2026-2/01_기말프로젝트_기획서_가이드.md)를 따른다. 1주차의 문제 후보와 첫 실행 추적은 8주차 제출 기획서의 첫 포트폴리오 증거가 된다. [16주 과정 로드맵](../curriculum/2026-2/web/course-roadmap.html)은 현재 주차를 파란색으로 표시하며, 9월 25일과 10월 9일은 온라인 영상 수업으로 구분한다.
