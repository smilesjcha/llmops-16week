...
def main() -> None:
    ...
    lines = [
        ...
        "",
        "> PPTX/PDF 원본은 로컬에 보존되어 있지만 총 약 882 MiB이며, 15주차 PPTX는 GitHub 일반 파일 한도 100 MiB를 넘는다. Git LFS를 구성하기 전까지 루트 `.gitignore`에서 제외한다.",
        "",
        "- 자료 주차: 01–07, 09–15주차",
        "- PPTX/PDF: 각각 14개",
        "- 전체 슬라이드/페이지: 1,002장",
    ...
    lines.extend(
        [
            ...
            "- SHA-256은 로컬 원본의 무결성 확인용이며 파일 내용의 저작권·배포 허가를 의미하지 않는다.",
